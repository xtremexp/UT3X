...
*/
class SBamboo extends S placeable; //Spawnable

DefaultProperties 
{ 
	Begin Object Name=StaticMeshComponent0 
		StaticMesh=StaticMesh'ASC_Foliage.SM.Mesh.S_ASC_Foliage_SM_Bamboo'
	...
	ReplicatedMesh = StaticMesh'ASC_Foliage.SM.Mesh.S_ASC_Foliage_SM_Bamboo';
}
