...
*/
class SLamp2 extends S placeable; //Spawnable

DefaultProperties 
{ 
	Begin Object Name=StaticMeshComponent0 
		StaticMesh=StaticMesh'ASC_Deco.SM.Mesh.S_ASC_Deco_SM_Standard01'
	...
	ReplicatedMesh = StaticMesh'ASC_Deco.SM.Mesh.S_ASC_Deco_SM_Standard01';
}
