...
*/
class STree1 extends S placeable; //Spawnable

DefaultProperties 
{ 
	Begin Object Name=StaticMeshComponent0 
		StaticMesh=StaticMesh'ASC_Foliage.SM.Mesh.S_ASC_Foliage_SM_Tree02b'
	...
	ReplicatedMesh = StaticMesh'ASC_Foliage.SM.Mesh.S_ASC_Foliage_SM_Tree02b';
}
