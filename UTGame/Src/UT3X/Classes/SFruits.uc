...
*/
class SFruits extends S placeable; //Spawnable

DefaultProperties 
{ 
	Begin Object Name=StaticMeshComponent0 
		StaticMesh=StaticMesh'ASC_Deco2.SM.Mesh.S_ASC_Deco_SM_FruitCrate01'
	...
	ReplicatedMesh = StaticMesh'ASC_Deco2.SM.Mesh.S_ASC_Deco_SM_FruitCrate01';
}
