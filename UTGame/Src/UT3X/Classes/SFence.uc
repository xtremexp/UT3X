...
*/
class SFence extends S placeable; //Spawnable

DefaultProperties 
{ 
	Begin Object Name=StaticMeshComponent0 
		StaticMesh=StaticMesh'HU_Deco.SM.Mesh.S_HU_Deco_SM_ChainlinkGate'
	...
	ReplicatedMesh = StaticMesh'HU_Deco.SM.Mesh.S_HU_Deco_SM_ChainlinkGate';
}
