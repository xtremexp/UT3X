...
*/
class SContainer extends S placeable; //Spawnable


DefaultProperties 
{ 
	Begin Object Name=StaticMeshComponent0 
		StaticMesh=StaticMesh'HU_Deco.SM.Mesh.S_HU_Deco_SM_Container_Open_smooth'
	...
	ReplicatedMesh = StaticMesh'HU_Deco.SM.Mesh.S_HU_Deco_SM_Container_Open_smooth';
}
